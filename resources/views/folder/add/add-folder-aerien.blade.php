        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered" id="form_wizard_1">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-blue bold uppercase"> Ajouter un dossier <span
                                    class="label label-sm label-info">Aerien</span> -
                ...
                <div class="portlet-body form">
                    <form action="{{ url('/folder/arial/add') }}" class="form-horizontal" id="submit_form"
                          method="POST">
                            ...
                            <div class="form-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab4">
                                        ...
                                        <div class="form-group" style="margin-bottom: 0px">
                                            <label class="control-label col-md-3">Num Vol:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="vol"></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            <label class="control-label col-md-3">Num LTA:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="lta"></p>
                                            </div>
                                        </div>
