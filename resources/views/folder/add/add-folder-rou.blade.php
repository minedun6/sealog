        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered" id="form_wizard_1">
                    ...
                    <div class="caption">
                        <i class=" icon-layers font-blue"></i>
                                        <span class="caption-subject font-blue bold uppercase"> Ajouter un dossier <span
                                                    class="label label-sm label-success">Routier</span> -
                ...
                <div class="portlet-body form">
                    <form action="{{ url('folder/road/add') }}" class="form-horizontal" id="submit_form" method="POST">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab1">
                                        ...
                                        <div class="supplem" id="Routier">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Num CMR

                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="cma"/>
                                                    <span class="help-block">  </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" id="tab4">
                                        ...
                                        <div class="form-group" style="margin-bottom: 0px">
                                            ...
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="embarq_place"></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            <label class="control-label col-md-3">Lieu de débarquement:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="debarq_place"></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            <label class="control-label col-md-3">Remorque:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="camion"></p>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 0px">
                                            <label class="control-label col-md-3">Num CMR:</label>
                                            <div class="col-md-4">
                                                <p class="form-control-static" data-display="CMA"></p>
                                            </div>
                                        </div>
