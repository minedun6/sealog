        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered" id="form_wizard_1">
                    ...
                    <div class="caption">
                        <i class=" icon-layers font-blue"></i>
                                        <span class="caption-subject font-blue bold uppercase"> Ajouter un dossier - <span
                                                    class="label label-sm label-info">Transit</span>
                ...
                <div class="portlet-body form">
                    <form action="{{ url('folder/transit/add') }}" class="form-horizontal" id="submit_form"
                          method="POST">
                                            ...
                                            <div class="col-md-4">
                                                <div class="radio-list" id="place_errors">
                                                    <label>
                                                        ...
                                                        <input type="radio" name="type" data-title="Export"
                                                               value="export"
                                                        ...
                                                        Export </label>
                                                    <label>
                                                        <input type="radio" name="type" data-title="Import"
                                                               value="import"
                                                               id="export_id"
