...
function ConvNumberLetter(Nombre, Devise, Langue) {
    ...
    console.log(Nombre + ' - ' + dblEnt + ' = ' + ((Nombre - dblEnt).toFixed(3)*1000));
    byDec = (Nombre - dblEnt).toFixed(3)*1000 ;
    console.log(byDec);
    if( byDec == 0 ) {
    ...
    switch(Devise) {
        ...
        case 1 :
            strDev = " Dinar" ;
            if (byDec > 0) strCentimes = strCentimes + " Millimes" ;
            break;
        case 2 :
            strDev = " Dollar" ;
    ...
    var NumberLetter = ConvNumEnt(parseFloat(dblEnt), Langue) + strDev + " " + ConvNumEnt(byDec, Langue) + strCentimes ;
    return NumberLetter;
}
